Contributing to MuBdI Core
============================

The MuBdI Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MuBdI Core project, and is not to be
confused with overall MuBdI Network Protocol consensus changes.

Whether a pull request is merged into MuBdI Core rests with the project merge
...
Patches that change MuBdI consensus rules are considerably more involved than
...
Where a patch set proposes to change the MuBdI consensus, it must have been
...
The project leader is the release manager for each MuBdI Core release.
